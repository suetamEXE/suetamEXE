...
on:
  schedule:
    - cron: "0 */24 * * *" # Corre automaticamente a cada 24 horas
  workflow_dispatch: # Permite-te rodar manualmente quando quiseres
  push:
    branches:
      - main
